...
public class Game {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String playerName= "Team Space Games";
                ...
                if ((player.is_alive()) && (!player.victory)){
                    ...
                    for (Action action:available_actions){
                        if (action_input == action.getHotkey()){
                            ...
                            if (room instanceof FlyHomeRoom && action.getHotkey() == 'f') {
                                // End the game if the player is in the LeaveCaveRoom tile and has selected the Exit game action
                                player.victory = true;}
                            break;
                        }
                    }
